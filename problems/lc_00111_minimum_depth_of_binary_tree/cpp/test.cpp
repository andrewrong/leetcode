...
int main() {
    ...
    assert(solution.minDepth(root1) == 0);
    ...
    assert(solution.minDepth(&root3) == 2);
    ...
    assert(solution.minDepth(&root4) == 4);
    ...
    assert(solution.minDepth(&root5) == 3);

    // Test case 6: Tree with one child being null
    //       1
    //      / \
    //     2   null
    TreeNode node2single(2);
    TreeNode root6(1, &node2single, nullptr);
    assert(solution.minDepth(&root6) == 2);
