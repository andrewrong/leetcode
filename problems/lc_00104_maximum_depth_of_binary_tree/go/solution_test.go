...
func TestMaxDepth(t *testing.T) {
	...
	var root1 *TreeNode
	expected1 := 0
	if result := maxDepth(root1); result != expected1 {
	...
	expected2 := 1
	if result := maxDepth(root2); result != expected2 {
	...
	expected3 := 3
	if result := maxDepth(root3); result != expected3 {
	...
	expected4 := 4
	if result := maxDepth(root4); result != expected4 {
	...
	expected5 := 3
	if result := maxDepth(root5); result != expected5 {
